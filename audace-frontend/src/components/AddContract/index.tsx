                ...
                <Row className="mb-3">
                  <Col>
                    <Form.Group controlId="formBasicSupervisorFirstName">
                      ...
                      <Form.Control type="text" size="sm" value={supervisorFirstName} onChange={(e) => setSupervisorFirstName(e.target.value)}/>
                  ...
                  <Col>
                    <Form.Group controlId="formBasicSupervisorLastName">
                      ...
                      <Form.Control type="text" size="sm" value={supervisorLastName} onChange={(e) => setSupervisorLastName(e.target.value)}/>
                ...
                <Row className="mb-3">
                  <Col>
                    <Form.Group controlId="formBasicSupervisorEmail">
                      ...
                      <Form.Control type="email" size="sm" value={supervisorEmail} onChange={(e) => setSupervisorEmail(e.target.value)}/>
                      {errors.includes("contract.errors.invalidStartHour")}
                    </Form.Group>
                  </Col>
                  <Col>
                    <Form.Group controlId="formBasicSupervisorPosition">
                      ...
                      <Form.Control type="text" size="sm" value={supervisorPosition} onChange={(e) => setSupervisorPosition(e.target.value)}/>
                      {errors.includes("contract.errors.invalidEndHour")}
                    </Form.Group>
                  </Col>
                </Row>
                <Row className="mb-3">
                  <Col>
                    <Form.Group controlId="formBasicSupervisorPhone">
                      ...
                      <Form.Control type="phone" size="sm" value={supervisorPhone} onChange={(e) => setSupervisorPhone(e.target.value)}/>
                      {errors.includes("contract.errors.invalidStartHour")}
                    </Form.Group>
                  </Col>
                  <Col>
                    <Form.Group controlId="formBasicSupervisorExtension">
                      ...
                      <Form.Control type="text" size="sm" value={supervisorExtension} onChange={(e) => setSupervisorExtension(e.target.value)}/>
                      {errors.includes("contract.errors.invalidEndHour")}
                    </Form.Group>
                  </Col>
                </Row>
        ...
        <Row className="mb-3">
          ...
          <Col>
            <Form.Group controlId="formBasicSalary">
              ...
              <Form.Control type="number" size="sm" min="1" value={salary}
